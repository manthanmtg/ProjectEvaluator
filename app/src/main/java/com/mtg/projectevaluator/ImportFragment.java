...
public class ImportFragment extends Fragment {
    ...
    private static final String BUTTON_TEXT = "Call API";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mCallApiButton = view.findViewById(R.id.mCallApiButton);
        sheetId = view.findViewById(R.id.sheetID);
        ...
        mOutputText = view.findViewById(R.id.mOutputText);
        mOutputText.setPadding(16, 16, 16, 16);
        mOutputText.setVerticalScrollBarEnabled(true);
        mOutputText.setMovementMethod(new ScrollingMovementMethod());
        mOutputText.setText(
                "Click the \'" + BUTTON_TEXT + "\' button to call the API.");
    ...
    private void chooseAccount() {
        if (EasyPermissions.hasPermissions(
                Objects.requireNonNull(getContext()), Manifest.permission.GET_ACCOUNTS)) {
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            String spreadsheetId = sheetId.getText().toString();
            //String spreadsheetId = "1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgvE2upms";
            String range = "Sheet1!A2:J5";
            ...
            if (values != null) {
                ...
                for (List row : values) {
                    ...
                    myDb.insertDataDetails(row.get(0).toString(), row.get(1).toString(),
                            row.get(2).toString(), row.get(3).toString(),
                            row.get(4).toString(), row.get(5).toString(), row.get(6).toString(),
                            row.get(7).toString(), row.get(8).toString(), row.get(9).toString());
                }
            }
            return results;
        }
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            ImportFragment.REQUEST_AUTHORIZATION);
                } else {
